...
class admin_controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hehe == 'onek_boro_hehe' && $request->HEHE == 'choto_choto_hehe'){
            ...
            return redirect('/shuvrodaadminview');
        }
    ...
    public function edit($id)
    {
        ...
        $problem = Problemset::where('slug', $id)->first();
    ...
    public function editstore(Request $request, $id)
    {
        ...
        $problemset = Problemset::where('slug', $id)->first();
        ...
        return redirect('/shuvrodaadminview')->with('success', 'প্রবলেমটি সফলভাবে আপডেট করা হয়েছে।');
    }
}
